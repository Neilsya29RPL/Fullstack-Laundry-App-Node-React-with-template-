...
export default class Cetak extends React.Component {
    ...
    render() {
        return (
            <div>
                <div className="row">     
          <div className="col-16 card shadow p-4 border-0">
          <div className="bg-gradient-primary border-radius-lg pt-4 pb-3">
                <h4 className="text-white text-capitalize ps-3">Laporan Transaksi</h4>
            </div> 
            <table class="table table-bordered">
              ...
              <tr>
                  ...
                  <tr>
                    ...
                    <div className="bg-gradient-primary border-radius-lg pt-4 pb-3">
                        <h4 className="text-white text-capitalize ps-3">Detail Paket</h4>
                    </div>
